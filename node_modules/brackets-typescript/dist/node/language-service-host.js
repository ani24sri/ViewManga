...
var typescriptPath = ts_path_utils_1.normalizePath(path.dirname(require.resolve('typescript')));
var TypeScriptLanguageServiceHost = (function () {
    function TypeScriptLanguageServiceHost(ts, projectDirectory, compilationSettings, fileNames) {
        var _this = this;
        this.ts = ts;
